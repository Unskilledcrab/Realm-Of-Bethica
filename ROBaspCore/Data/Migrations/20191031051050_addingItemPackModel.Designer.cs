...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ROBaspCore.Models.ArcanePowerAttributeModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ROBaspCore.Models.ArcaneSubgroupModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ROBaspCore.Models.ArcaneSubgroup_ArcanePowerAttribute_Link", b =>
                {
            ...
            modelBuilder.Entity("ROBaspCore.Models.ItemPackModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ROBaspCore.Models.ItemPack_Item_Link", b =>
                {
            ...
            modelBuilder.Entity("ROBaspCore.Models.Spell_ArcanePowerAttribute_Link", b =>
                {
                    b.Property<int>("SpellId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ROBaspCore.Models.ArcaneSubgroup_ArcanePowerAttribute_Link", b =>
                {
                    b.HasOne("ROBaspCore.Models.ArcanePowerAttributeModel", "ArcanePowerAttribute")
                        .WithMany("RequiredArcaneSubgroups")
                        .HasForeignKey("ArcanePowerAttributeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ROBaspCore.Models.ArcaneSubgroupModel", "ArcaneSubgroup")
            ...
            modelBuilder.Entity("ROBaspCore.Models.ItemPack_Item_Link", b =>
                {
                    ...
                    b.HasOne("ROBaspCore.Models.ItemPackModel", "ItemPack")
                        .WithMany("Items")

...
namespace ROBaspCore.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var emailResult = await _signInManager.UserManager.FindByEmailAsync(Input.UserName).ConfigureAwait(false);
                if (emailResult != null) Input.UserName = emailResult.UserName;
